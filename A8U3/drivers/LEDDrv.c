...
GPIO_Type *rGpioB = GPIOB; 			/* Peripheral GPIOA base address */
GPIO_Type *rGpioD = GPIOD;			/* Peripheral GPIOB base address */
/*******************************************************************************
 * Code
 ******************************************************************************/
...
void vfnLEDsInit(void)
{
	...
	PORT_Type *rPortB = PORTB;			/* Peripheral PORTA base pointer */
	PORT_Type *rPortD = PORTD;			/* Peripheral PORTB base pointer */
